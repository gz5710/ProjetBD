...
<div class="row">
    ...
    <div class="box-header well" data-original-title="">
        <h2><i class="glyphicon glyphicon-list-alt"></i> New File</h2>
    ...
    <div class="alert alert-info">Upload a new File.</div>
...
<table class="table table-striped table-bordered bootstrap-datatable datatable responsive">
	...
	<tr>
		<td>Descriptions : </td>
		<td><textarea style="height: 200px; width: 300px" name="descriptions"><%=file.getDescription() %></textarea></td>
	</tr>
	<tr>
		<td>Views : </td>
...
<input type="hidden" name="vu" value="<%=file.getVu() %>">
