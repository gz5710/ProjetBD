...
<div class="row">
    ...
    <div class="box-header well" data-original-title="">
        <h2><i class="glyphicon glyphicon-list-alt"></i> File [ <%=file.getNom() %> ]</h2>
    ...
    <div class="alert alert-info">File's informations.</div>
		...
		<tr>
			<td colspan="2">
				<%
					...
					java.io.File f = new java.io.File(file.getChemin());
					//path = path.replace("\\", "/");
				%>
				<embed src="../../dossier/<%=f.getName() %>" Style="width:100%; height: 600px" autoplay="false">
			</td>
		</tr>
	</tfoot>
</table>
