...
<div class="row">
    ...
    <div class="box-header well" data-original-title="">
        <h2><i class="glyphicon glyphicon-comment"></i> User Group</h2>
    ...
    <div class="alert alert-info">Following is the user group list.</div>
...
<%
	for(Role r : roles)
	{
		...
		<tr>
	        ...
	        <td class="center"><%=r.getCreateTime() %></td>
	        <td class="center">
	            
	        	<a href="UserGroupEdit.jsp?rolename=<%=r.getRole()%>" class="btn btn-info">
