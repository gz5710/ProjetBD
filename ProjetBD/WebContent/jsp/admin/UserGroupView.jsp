...
<div class="row">
	...
	{
	%>
    <div class="alert alert-info">Following are the users who are in this group.</div>
...
<%
	for(User user : usersInRole)
	{
		...
		<tr>
	        ...
	        <td class="center"><%=user.getDate_Dernier_Acces() %></td>
	        <td class="center">
...
%>
		...
		%>
		<div class="alert alert-info">None of user in this group.</div>
		<%
	}
%> 
                </div>
...
<!-- <div class="row"> -->
    ...
    <div class="box-inner">
    <div class="box-header well" data-original-title="">
        <h2><i class="glyphicon glyphicon-briefcase"></i> File Group Related</h2>
...
%>
		...
		%>
		<div class="alert alert-info">This group can't access any file group.</div>
		<%
	}
%>   
                </div>
