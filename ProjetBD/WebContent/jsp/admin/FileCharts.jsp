<%@page import="com.DB.control.Util"%>
...
<div class="row">
    ...
    <div class="box-header well" data-original-title="">
        <h2><i class="glyphicon glyphicon-list-alt"></i> File Charts</h2>
    ...
    <div class="alert alert-info">Charts about the files</div>
    ...
    <embed src="/ProjetBD/<%= Util.CHART_FILETYPE_PATH%>"><br><br><br><br><br>
    <embed src="/ProjetBD/<%= Util.CHART_FILEGROUP_PATH%>"><br><br><br><br><br>
    <embed src="/ProjetBD/<%= Util.CHART_FILEVIEW_PATH%>"><br><br>
                </div>
            </div>
        </div>
        <!--/span-->
