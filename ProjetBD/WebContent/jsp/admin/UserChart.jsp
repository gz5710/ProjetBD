...
<div class="row">
    ...
    <div class="box-header well" data-original-title="">
        <h2><i class="glyphicon glyphicon-list-alt"></i> User Login Chart</h2>
    ...
    <div class="alert alert-info">User's login records</div>
	...
	<embed src="/ProjetBD/<%= Util.CHART_USER_PATH%>">
                </div>
            </div>
        </div>
        <!--/span-->
